            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="alert alert-success alert-dismissible">
                        ...
                        <img src="<?php echo $imgUrl ?>" class="rounded img-thumbnail mr-2" style="width:40px;"><?php echo $getProductData['product_name']?> wird in den Warenkorb gelegt. <a href="cart.php" class="alert-link">Warenkorb ansehen</a>
                    </div>
                </div>
            </div>
         <?php }?>
            ...
            <div class="col-md-7">
                ...
                <form class="form-inline" method="POST">
                    ...
                    <div class="form-group mb-2 ml-2">
                        <button type="submit" class="btn btn-primary" name="add_to_cart" value="add to cart">in den Warenkorb</button>
                    </div>
                </form>
