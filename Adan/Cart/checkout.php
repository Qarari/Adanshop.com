...
<div class="row mt-3">
        <div class="col-md-4 order-md-2 mb-4">
          <h4 class="d-flex justify-content-between align-items-center mb-3">
            <span class="text-muted">Warenkorb-Übersicht</span>
                ...
                ?>
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            ...
                            <small class="text-muted">Menge: <?php echo $cartItem['qty'] ?> X Preis: <?php echo $cartItem['product_price'] ?></small>
                        </div>
        ...
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Rechnung Addresse</h4>
          <?php 
          ...
          <form class="needs-validation" method="POST">
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="firstName" name="first_name" placeholder="vorname" value="<?php echo (isset($fnameValue) && !empty($fnameValue)) ? $fnameValue:'' ?>" >
              </div>
              <div class="col-md-6 mb-3">
                <label for="lastName">Nachname</label>
                <input type="text" class="form-control" id="lastName" name="last_name" placeholder="nachname" value="<?php echo (isset($lnameValue) && !empty($lnameValue)) ? $lnameValue:'' ?>" >
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="address" name="address" placeholder="1234 Strasse" value="<?php echo (isset($addressValue) && !empty($addressValue)) ? $addressValue:'' ?>">
            </div>

            <div class="mb-3">
              <label for="address2">Addresse 2 <span class="text-muted">(Optional)</span></label>
              <input type="text" class="form-control" id="address2" name="address2" placeholder="Alternative" value="<?php echo (isset($address2Value) && !empty($address2Value)) ? $address2Value:'' ?>">
            </div>
            ...
            <div class="d-block my-3">
              <div class="custom-control custom-radio">
                ...
                <label class="custom-control-label" for="cashOnDelivery">Barzahlung bei Lieferung</label>
              </div>
            </div>
           
            <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" type="submit" name="submit" value="submit">Jetzt kaufen</button>
          </form>
        </div>
      </div>
